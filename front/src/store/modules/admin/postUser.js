...
const state = {
  ...
  pageInfo: {
    ...
    PAGE_URL: '/admin/usuarios-de-noticias',
    TITLE_NAME: 'Usuário de Notícia',
    TITLE_NAME_PLURAL: 'Usuários de Notícias',

    LOAD_DISPLAY_URL: process.env.API_URL + 'api/admin/post-user/load-display',
    STORE: process.env.API_URL + 'api/admin/post-user/store',
    UPDATE: process.env.API_URL + 'api/admin/post-user/update',
    DESTROY: process.env.API_URL + 'api/admin/post-user/destroy',
    LOAD_FORM: process.env.API_URL + 'api/admin/post-user/load-form',
