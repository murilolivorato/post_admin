...
const state = {
  ...
  // PAGE INFO
  pageInfo: {
    URL_PATH: '/assets/fotos/',

    PAGE_URL: '/admin/categorias-de-noticias',
    TITLE_NAME: 'Categoria de Notícia',
    TITLE_NAME_PLURAL: 'Categorias de Notícias',

    LOAD_DISPLAY_URL: process.env.API_URL + 'api/admin/post-category/load-display',
    STORE: process.env.API_URL + 'api/admin/post-category/store',
    UPDATE: process.env.API_URL + 'api/admin/post-category/update',
    DESTROY: process.env.API_URL + 'api/admin/post-category/destroy',
    LOAD_FORM: process.env.API_URL + 'api/admin/post-category/load-form',
