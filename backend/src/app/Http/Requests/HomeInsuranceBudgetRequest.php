...
class HomeInsuranceBudgetRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'property_type_id'   => 'required|min:1' ,
            'is_condo'           => 'required|min:1' ,
            'main_property'      => 'required|min:1' ,
            'price_insurance'    => 'required|numeric|min:50|max:10000000',
            'property_cep'       => 'required|min:3|max:32',
